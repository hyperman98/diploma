		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2>Редактирование услуги #<?php echo $id;?></h2>
					</div>
					<!-- End Box Head -->
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form">
								<p>
									...
									<input name="name" type="text" class="field size1" value="<?php echo $categories['name']; ?>"/>
								</p>
								<p>
									<label><span>Изображение</span></label>
									<img src="<?php echo Category::getImage($categories['id']);?>" width="150">
								...
								<p>
									...
									<textarea name="full_text" class="field size1" rows="10" cols="30"
                  ><?php echo $categories['full_text'] ?></textarea>
								</p>
