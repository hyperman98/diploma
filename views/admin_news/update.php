		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2>Редактирование новости #<?php echo $id;?></h2>
					</div>
					<!-- End Box Head -->
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form">
								<p>
									...
									<input name="title" type="text" class="field size1" value="<?php echo $news['title']; ?>"/>
								</p>
								<p>
									<label><span>Изображение</span></label>
									<img src="<?php echo News::getImage($news['id']);?>" width="100" alt="">
								...
								<p>
									...
									<textarea name="short_content" class="field size1" rows="10" cols="30"
                  ><?php echo $news['short_content'] ?></textarea>
								</p>
