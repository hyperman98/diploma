		...
		<div id="main">
			...
			<div id="content">
                ...
                <td><h3><a href="#"><?php echo $item['id']; ?></a></h3></td>
								...
								<td><h3><?php echo $item['tel']; ?></h3></td>
								<td><h3><?php echo Order::getStatusSerText($item['status']);?>
							</h3></td>
								<td><a style="margin-left:15px;" href="/admin/orders/delete/<?php echo $item['id'];?>" class="ico del">Удалить</a><a style="margin-left:15px;" href="/admin/orders/update/<?php echo $item['id'];?>" class="ico del">Изменить</a></td>
                </tr>
              <?php endforeach; ?>
							<!-- <tr class="odd">
								<td><input type="checkbox" class="checkbox" /></td>
