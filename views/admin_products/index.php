		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Нынешние товары</h2>
						<!-- <div class="right">
                ...
                <td><h3><a href="#"><?php echo $item['id']; ?></a></h3></td>
								...
								<td><h3><?php echo $item['price']; ?></h3></td>
								<td><h3><?php echo $item['description']; ?></h3></td>
								<td><a href="/admin/products/delete/<?php echo $item['id'];?>" class="ico del">Удалить</a><a href="/admin/products/update/<?php echo $item['id'];?>" class="ico edit">Изменить</a></td>
                </tr>
              <?php endforeach; ?>
							<!-- <tr class="odd">
								<td><input type="checkbox" class="checkbox" /></td>
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form">
								...
								<p>
									...
									<textarea name="description" class="field size1" rows="10" cols="30"></textarea>
								</p>

								<p>
									<label><span>Цена</span></label>
									<input name="price" class="field size1" rows="10" cols="30"></input>
								</p>
