		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Нынешние услуги</h2>
						<!-- <div class="right">
                ...
                <td><h3><a href="#"><?php echo $item['id']; ?></a></h3></td>
								...
								<td><a href="/admin/category/delete/<?php echo $item['id'];?>" class="ico del">Удалить</a><a href="/admin/category/update/<?php echo $item['id'];?>" class="ico edit">Изменить</a></td>
                </tr>
              <?php endforeach; ?>
							<!-- <tr class="odd">
								<td><input type="checkbox" class="checkbox" /></td>
