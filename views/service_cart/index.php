                  ...
                  <table class="cart">
                    ...
                    <?php foreach ($products as $product): ?>
                        <tr>
                            ...
                            <td>
                              <a href="/service-cart/delete/<?php echo $product['id']; ?>">
                                  <i style="margin-top:10px; margin-left:20px;" class="fa fa-times"></i>
                            </a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    ...
                    <?php else: ?>
                      <h1 style="font-size:2.5em;"><span class="color-1">Записей </span>на услуги нет</h1><br><br><br>
